...
class GestureRecognizer:
    ...
    def __init__(self):
        ...
        # Initialize MediaPipe Hand Landmarker using video mode.
        # This improves temporal stability versus independent per-frame image mode.
        ...
        options = vision.HandLandmarkerOptions(
            ...
            min_hand_presence_confidence=config.MP_DETECTION_CONFIDENCE,
